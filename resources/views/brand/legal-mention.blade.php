...
<main class="main">
    <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        <div class="container">
            <h1 class="page-title">Mentions légales<span>La marque</span></h1>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('about') }}">La marque</a></li>
    ...
    <div class="page-content">
        <div class="container">
            <h2 class="title text-center mb-3" id="shipping">Shipping Information</h2><!-- End .title -->
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9 col-xl-7">
                    <div class="row no-gutters flex-column flex-sm-row align-items-sm-center">
                        <div class="col">
                            <h3 class="cta-title text-white">Si vous avez d'autres questions</h3><!-- End .cta-title -->
                            <p class="cta-desc text-white">N'hésitez pas à nous contacter</p><!-- End .cta-desc -->
                        </div><!-- End .col -->

                        <div class="col-auto">
                            <a href="{{ route('contact') }}" class="btn btn-outline-white"><span>Contactez nous</span><i class="icon-long-arrow-right"></i></a>
                        </div><!-- End .col-auto -->
