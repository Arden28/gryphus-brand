...
<main class="main">
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-4">
                        <div class="banner banner-overlay banner-lg">
                            <a href="#">
                                <img src="{{ asset('assets/images/demos/demo-9/banners/banner-1.jpg')}}" alt="Banner">
                            </a>
                            ...
                            <div class="banner-content banner-content-bottom">
                                ...
                                <a href="#" class="btn btn-outline-white banner-link">Découvrez maintenant</a>
                    ...
                    <div class="col-sm-6 col-lg-4 order-lg-last">
                        <div class="banner banner-overlay banner-lg">
                            <a href="#">
                                <img src="{{ asset('assets/images/demos/demo-9/banners/banner-4.jpg')}}" alt="Banner">
                            </a>
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        ...
                        <div class="product product-7 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('assets/images/demos/demo-9/products/product-1-1.jpg')}}" alt="Product image" class="product-image">
                                    <img src="{{ asset('assets/images/demos/demo-9/products/product-1-2.jpg')}}" alt="Product image" class="product-image-hover">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <div class="product-nav product-nav-thumbs">
                                    <a href="#" class="active">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-1-thumb.jpg')}}" alt="product desc">
                                    </a>
                                    <a href="#">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-1-2-thumb.jpg')}}" alt="product desc">
                                    </a>
                                    <a href="#">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-1-3-thumb.jpg')}}" alt="product desc">
                                    </a>
                                </div><!-- End .product-nav -->
                        ...
                        <div class="product product-7 text-center">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="{{ asset('assets/images/demos/demo-9/products/product-3-1.jpg')}}" alt="Product image" class="product-image">
                                    <img src="{{ asset('assets/images/demos/demo-9/products/product-3-2.jpg')}}" alt="Product image" class="product-image-hover">
                                </a>
                        ...
                        <div class="product product-7 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="{{ asset('assets/images/demos/demo-9/products/product-4-1.jpg')}}" alt="Product image" class="product-image">
                                    <img src="{{ asset('assets/images/demos/demo-9/products/product-4-2.jpg')}}" alt="Product image" class="product-image-hover">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <div class="product-nav product-nav-thumbs">
                                    <a href="#" class="active">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-4-thumb.jpg')}}" alt="product desc">
                                    </a>
                                    <a href="#">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-4-2-thumb.jpg')}}" alt="product desc">
                                    </a>
                                </div><!-- End .product-nav -->
                            </div><!-- End .product-body -->
                        </div><!-- End .product -->
                        ...
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                            ...
                            <div class="product product-7">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-5-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-5-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-7">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-6-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-6-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-7">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-7-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-7-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                    ...
                    <div class="tab-pane p-0 fade show active" id="bags-women-tab" role="tabpanel" aria-labelledby="bags-women-link">
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                            ...
                            <div class="product product-7 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-8-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-8-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-7 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-9-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-9-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-7 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-10-1.jpg')}}" alt="Product image" class="product-image">
                                        <img src="{{ asset('assets/images/demos/demo-9/products/product-10-2.jpg')}}" alt="Product image" class="product-image-hover">
                                    </a>
                                ...
                                <div class="product-body">
                                    ...
                                    <div class="product-nav product-nav-thumbs">
                                        <a href="#" class="active">
                                            <img src="{{ asset('assets/images/demos/demo-9/products/product-10-thumb.jpg')}}" alt="product desc">
                                        </a>
                                        <a href="#">
                                            <img src="{{ asset('assets/images/demos/demo-9/products/product-10-2-thumb.jpg')}}" alt="product desc">
                                        </a>
                                    </div><!-- End .product-nav -->
                                </div><!-- End .product-body -->
                            </div><!-- End .product -->
    ...
    <div class="owl-carousel owl-simple" data-toggle="owl"
        ...
        <div class="instagram-feed">
            <img src="{{ asset('assets/images/demos/demo-9/instagram/1.jpg')}}" alt="img">
        ...
        <div class="instagram-feed">
            <img src="{{ asset('assets/images/demos/demo-9/instagram/2.jpg')}}" alt="img">
        ...
        <div class="instagram-feed">
            <img src="{{ asset('assets/images/demos/demo-9/instagram/3.jpg')}}" alt="img">
        ...
        <div class="instagram-feed">
            <img src="{{ asset('assets/images/demos/demo-9/instagram/4.jpg')}}" alt="img">
        ...
        <div class="instagram-feed">
            <img src="{{ asset('assets/images/demos/demo-9/instagram/5.jpg')}}" alt="img">
        ...
        <div class="instagram-feed">
            <img src="{{ asset('assets/images/demos/demo-9/instagram/6.jpg')}}" alt="img">
