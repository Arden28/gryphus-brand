...
<main class="main">
    <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        <div class="container">
            <h1 class="page-title">Mon panier<span>La Boutique</span></h1>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
                ...
                <div class="row">
                    ...
                    <aside class="col-lg-3">
                        <div class="summary summary-cart">
                            ...
                            <a href="checkout.html" class="btn btn-outline-primary-2 btn-order btn-block">PROCEDER AU PAIEMENT</a>
                        </div><!-- End .summary -->
