                    ...
                    <div class="toolbox">
                        <div class="toolbox-left">
                            <div class="toolbox-info">
                                Produits <span>1-12</span> sur 105
                            ...
                            <div class="toolbox-sort">
                                ...
                                <div class="select-custom">
                                    <select name="sortby" id="sortby" class="form-control">
                                        ...
                                        <option value="popularity">Prix(- cher)</option>
                                        <option value="rating">Prix(+ cher)</option>
                            ...
                            <div class="collapse show" id="widget-2">
                                <div class="widget-body">
                                    <div class="filter-items">
                                        ...
                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" value="m" class="custom-control-input" checked id="size-3">
                                        ...
                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" value="l" class="custom-control-input" checked id="size-4">
                                        ...
                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" value="xxl" class="custom-control-input" id="size-6">
                            ...
                            <div class="collapse show" id="widget-4">
                                <div class="widget-body">
                                    <div class="filter-items">
                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" value="male" class="custom-control-input" id="brand-1">
                                                <label class="custom-control-label" for="brand-1">Homme</label>
                                            </div><!-- End .custom-checkbox -->
                                        </div><!-- End .filter-item -->

                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" value="female" class="custom-control-input" id="brand-2">
                                                <label class="custom-control-label" for="brand-2">Femme</label>
                                            </div><!-- End .custom-checkbox -->
                                        </div><!-- End .filter-item -->

                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" value="adult" class="custom-control-input" id="brand-3">
                                                <label class="custom-control-label" for="brand-3">Adultes</label>
                                            </div><!-- End .custom-checkbox -->
                                        </div><!-- End .filter-item -->

                                        <div class="filter-item">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" value="kid" class="custom-control-input" id="brand-4">
                                                <label class="custom-control-label" for="brand-4">Enfants & Ados</label>
                                            </div><!-- End .custom-checkbox -->
                                        </div><!-- End .filter-item -->
